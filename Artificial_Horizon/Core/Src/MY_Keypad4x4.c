...
void Keypad4x4_ReadKeypad(bool keys[16])
{
	...
	while(HAL_GPIO_ReadPin(KeypadStruct.IN0_Port, KeypadStruct.IN0pin));
	keys[4] = HAL_GPIO_ReadPin(KeypadStruct.IN1_Port, KeypadStruct.IN1pin);
	while(HAL_GPIO_ReadPin(KeypadStruct.IN1_Port, KeypadStruct.IN1pin));
	keys[8] = HAL_GPIO_ReadPin(KeypadStruct.IN2_Port, KeypadStruct.IN2pin);
	while(HAL_GPIO_ReadPin(KeypadStruct.IN2_Port, KeypadStruct.IN2pin));
	keys[12] = HAL_GPIO_ReadPin(KeypadStruct.IN3_Port, KeypadStruct.IN3pin);
	while(HAL_GPIO_ReadPin(KeypadStruct.IN3_Port, KeypadStruct.IN3pin));
